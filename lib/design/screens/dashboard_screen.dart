      ...
      builder: (_) => AlertDialog(
                  ...
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                              "👤 Usuario: ${selectedUser!.name} ${selectedUser!.surnames}",
                              style:
                                  const TextStyle(fontWeight: FontWeight.bold)),
                          const SizedBox(height: 6),
                          Text(
                              "🛣 Ruta actual: ${selectedUser?.numRoute ?? 0}"),
                          const SizedBox(height: 6),
                          Text(
                              "🔢 Orden: ${selectedUser?.numPick ?? 'Sin determinar'}"),
                        ],
                      ),
                    ),
                  ),
        ...
        actions: [
          ...
          TextButton(
            ...
            onPressed: () {
              if (selectedUser != null) {
                activeProvider.assignRoute(
                    selectedUser!, selectedRoute, pickOrder);
              }
          ...
          TextButton(
            ...
            onPressed: () async {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                    content: Text('Nueva ruta creada exitosamente'),
                    backgroundColor: Colors.green),
              );
            },
          ...
          TextButton(
            ...
            onPressed: selectedRoute != null
                ? () async {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                          content: Text('Ruta $selectedRoute eliminada'),
                          backgroundColor: Colors.green),
                    );
                  }
                : null,
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: _isMenuOpen
            ...
            : _scrolledDown
                ? Colors.black
                    .withOpacity(0.5) // negro transparente al hacer scroll
                : Colors.transparent,
        elevation: 0,
        title: Row(
          children: [
